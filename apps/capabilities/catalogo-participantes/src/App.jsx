...
const MFES_CONFIG = [
  {
    id: 'participantes',
    url: import.meta.env.VITE_URL_PARTICIPANTES || "http://localhost:9094",
    label: "Participantes",
    icon: <Users size={20} />
  },
  {
    id: 'grupos',
    url: import.meta.env.VITE_URL_GRUPOS || "http://localhost:9095",
    label: "Grupos",
    icon: <UserPlus size={20} />
  },
  {
    id: 'relatorios',
    url: import.meta.env.VITE_URL_RELATORIOS || "http://localhost:9096",
    label: "Relatórios",
    icon: <BarChart3 size={20} />
  }
];

const CAPABILITY_TITLE = 'Catálogo de Participantes';
