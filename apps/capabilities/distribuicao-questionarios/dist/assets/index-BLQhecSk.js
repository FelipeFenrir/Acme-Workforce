...
function MenuSuperior({ mfeLabel }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "h-16 border-b border-zinc-800 bg-zinc-900/50 flex items-center px-8 justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-none bg-blue-600" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-black text-zinc-500 uppercase tracking-widest", children: mfeLabel })
  ] }) });
}
...
const MFES_CONFIG = [
  {
    ...
    label: "Questões",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleQuestionMark, { size: 20 })
  },
  {
    id: "questionarios",
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, { size: 20 })
  }
];
const CAPABILITY_TITLE = "Distribuição de Questionários";
function MFESidebar({ mfes, mfeAtivo, isCollapsed, onToggleCollapse, onTrocaMFE, capabilityTitle }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: `bg-zinc-900 border-r border-zinc-800 transition-all duration-300 relative flex flex-col ${isCollapsed ? "w-20" : "w-64"}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: onToggleCollapse,
        className: "absolute -right-3 top-10 bg-zinc-700 rounded-none p-1 z-50 hover:bg-zinc-600",
        children: isCollapsed ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { size: 14 })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 border-b border-zinc-800 flex flex-col gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: isCollapsed ? "hidden" : "block", children: "Voltar ao Hub" })
          ]
        }
      ),
      !isCollapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-bold text-zinc-300 leading-tight", children: capabilityTitle })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex-1 p-3 flex flex-col gap-2 mt-4", children: mfes.map((mfe) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: mfeAtivo === mfe.id ? "text-blue-500" : "group-hover:text-zinc-300", children: mfe.icon }),
          !isCollapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "whitespace-nowrap", children: mfe.label })
        ]
      },
      mfe.id
    )) })
...
function App() {
  const [mfeAtivo, setMfeAtivo] = reactExports.useState(MFES_CONFIG[0].url);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen bg-zinc-950 text-white overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      MFESidebar,
      {
        mfes: MFES_CONFIG,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 relative flex flex-col min-w-0 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MenuSuperior,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 relative overflow-hidden", children: [
        isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-10 flex items-center justify-center bg-zinc-950", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
