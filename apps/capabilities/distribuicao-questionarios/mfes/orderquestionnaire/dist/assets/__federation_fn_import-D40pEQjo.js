...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-DsCYf9hx.js', import.meta.url).href),import:true,requiredVersion:'^18.0.0'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-BE2wj_UA.js', import.meta.url).href),import:true,requiredVersion:'^18.0.0'}};
