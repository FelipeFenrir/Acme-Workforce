...
const Beef = createLucideIcon("beef", __iconNode$7);
...
const CookingPot = createLucideIcon("cooking-pot", __iconNode$5);
...
const Drama = createLucideIcon("drama", __iconNode$4);
...
const CAPACIDADES = [
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Drama, { size: 32 }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, { size: 32 }),
    color: "border-zinc-700/20 hover:border-zinc-700",
    accent: "bg-zinc-700",
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Beef, { size: 32 }),
    color: "border-zinc-700/20 hover:border-zinc-700",
    accent: "bg-zinc-700",
    url: null
  },
  {
    ...
    descricao: "Organize suas Prateleiras e Jornadas de Venda: Adicione/Remova Ofertas em Journadas de Venda ou Gerencia a relação entre Journadas e Canais de Venda.",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ShelvingUnit, { size: 32 }),
    color: "border-zinc-700/20 hover:border-zinc-700",
    accent: "bg-zinc-700",
    url: null
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CookingPot, { size: 32 }),
    color: "border-zinc-700/20 hover:border-zinc-700",
    accent: "bg-zinc-700",
    url: null
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Calculator, { size: 32 }),
    color: "border-zinc-700/20 hover:border-zinc-700",
    accent: "bg-zinc-700",
    url: null
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Handshake, { size: 32 }),
    color: "border-zinc-700/20 hover:border-zinc-700",
    accent: "bg-zinc-700",
    url: null
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutDashboard, { size: 32 }),
    color: "border-zinc-700/20 hover:border-zinc-700",
    accent: "bg-zinc-700",
    url: null
  }
...
function App() {
  const [capacidadeAtiva, setCapacidadeAtiva] = reactExports.useState(null);
  ...
  const renderCard = (cap) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-full h-full ${cap.accent} opacity-0 group-hover:opacity-100 transition-opacity duration-300` })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: { clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)" },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-none bg-zinc-900 flex items-center justify-center mt-4 mb-4 group-hover:scale-110 transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-300", children: cap.icon }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold mb-2 px-2 leading-tight", children: cap.titulo }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-500 text-xs leading-relaxed mb-4 overflow-hidden line-clamp-4", children: cap.descricao }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto mb-4 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `p-2 rounded-none ${cap.accent} text-white opacity-0 group-hover:opacity-100 transition-opacity`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { size: 16 }) }) })
            ]
          }
        )
      ]
  ...
  const renderHoneycomb = (items, cols) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center", children: rows.map((rowItems, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex gap-4 ${idx > 0 ? "-mt-[64px]" : ""}`, children: rowItems.map(renderCard) }, idx)) });
  };
  if (!capacidadeAtiva) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-zinc-950 text-white p-12 font-sans overflow-x-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "max-w-7xl mx-auto mb-16 flex flex-col items-center text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 bg-zinc-800 rounded-none flex items-center justify-center font-black", children: "A" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-black tracking-tighter uppercase text-zinc-100", children: "Acme Workforce" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-bold text-zinc-100", children: "O que vamos gerenciar hoje?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-500 mt-3 font-medium", children: "Escolha uma capacidade para acessar as ferramentas integradas." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block xl:hidden pb-8", children: renderHoneycomb(CAPACIDADES, 2) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden xl:block pb-16", children: renderHoneycomb(CAPACIDADES, 3) })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen bg-zinc-950 text-white overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "iframe",
      {
    ...
    isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-zinc-950", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 border-4 border-zinc-700 border-t-blue-500 rounded-full animate-spin" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-500 text-xs font-bold uppercase tracking-widest", children: "Carregando..." })
    ] }) })
  ] });
}
